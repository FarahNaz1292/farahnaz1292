...
- 📫 How to reach me **farahn1292@gmail.com**
...
> 💻 <strong>"Programs must be written for people to read, and only incidentally for machines to execute."</strong>  
> — <em>Harold Abelson</em>
...
The app has a responsive layout acheieved using css flexbox and grid sysytem

### 🛒 [Ecommerce Storefront](https://my-mega-mart.netlify.app/)
A responsive e-commerce application built with **javascript**, **HTML**, and **css**.  
Features product listings, cart functionality.

### 📈  [High Paid Jobs App](https://high-paid-jobs-app-y9th.vercel.app/)
A job portal app built with **Next.js**, **shadcn**, and **typescript**.  

### 🧑‍💻 [Recruiting Site](https://recruitingapp.netlify.app/)
This is a Vite project with **ReactJS** . **DaisyUI** and **tailwindcss** are used for UI designing. **React-router** and **react-router-dom** was used for routing.




<p align="center"><img align="center" src="https://github-readme-stats.vercel.app/api/top-langs?username=farahnaz1292&show_icons=true&locale=en&layout=compact" alt="farahnaz1292" /></p>
